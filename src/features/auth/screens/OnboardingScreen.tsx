      ...
      <View style={{ 
        ...
        <View style={{ alignItems: 'center', flex: 1, justifyContent: 'center' }}>
          <Text style={{ 
            ...
            <Text style={{ color: '#16A34A' }}>Fast &</Text>
            {'\n'}
            <Text style={{ color: '#16A34A' }}>Reliable</Text>
            {'\n'}
          ...
          <Text style={{ 
            ...
            Join us to deliver happiness. Start earning with flexible hours and great rewards.
          </Text>
